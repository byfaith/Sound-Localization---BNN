...
class SL_BNN(torch.nn.Module):
	...
	def forward(self, x):
		...
		"""
		x1 = F.hardtanh_(self.conv1_bn(self.conv1(x)))
		x2 = F.hardtanh_(self.conv2_bn(self.conv2(x1)))
		x3 = F.hardtanh_(self.conv3_bn(self.conv3(x2)))
		x4 = F.hardtanh_(self.conv4_bn(self.conv4(x3)))
		x4 = x4.view(-1, 192)
